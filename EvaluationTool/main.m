...
CamMapPath = '../Result/PVTSINet-FSRCNN-Loss-0.5/';   % Put model results in this folder.
Models = {'CHAMELEON'};   % You can add other model like this format: Models = {'2019-ICCV-EGNet','2019-CVPR-CPD'};
modelNum = length(Models);

% ---- 2. Ground-truth Datasets Setting ----
DataPath = '../Dataset/TestDataset/TestDataset/';
Datasets = {'CHAMELEON'};  % You may also need other datasets, such as Datasets = {'CAMO','CPD1K'};

% ---- 3. Results Save Path Setting ----
ResDir = './EvaluationResults/Result-CamObjDet-FSRCNN-Loss0.5/';
