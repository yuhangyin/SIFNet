...
from Src.SINet import SINet_PVT
...
parser.add_argument('--model_path', type=str,
                    default='./Snapshot/PVTSINet-cbam-1/SINet_40.pth')
parser.add_argument('--test_save', type=str,
                    default='./Result/PVTSINet-cbam-1/')
opt = parser.parse_args()

model = SINet_PVT(channel=32).cuda()
...
for dataset in ['CAMO','CHAMELEON','COD10K']:
    ...
    test_loader = test_dataset(image_root='./Dataset/TestDataset/TestDataset/{}/Imgs/'.format(dataset),
                               gt_root='./Dataset/TestDataset/TestDataset/{}/GT/'.format(dataset),
